...
# Encode / Decode file
# ---------------------------
def encode_onefile(input_txt: str, output_bin: str, level: int = 22):
    t_start = time.time()
...
# ---------------------------
def main():
    ap = argparse.ArgumentParser(description = "zstd nativo")
    ...
    if args.mode == "compress":
        out = args.output or f"zstd_native_{args.input.split('.')[0]}_compressed.bin"
